  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>Embark on a transformative educational jorney with our 
                university's comprenhensive education programs. Our cutting-edge
            ...
            <p> Whether you aspire to become a tecaher, administrator, 
                counselor, or educational leader, our diverse range of programs
                offers the perfect pathpay to achieve your goals and unlock your
